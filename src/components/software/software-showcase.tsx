...
export function SoftwareShowcase() {
  return (
    <section className="py-24 md:py-32 bg-card relative overflow-hidden border-b border-slate-100 dark:border-white/5">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-32">
          <div className="lg:w-1/2">
            ...
            >
              ...
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground tracking-tight mb-6 leading-tight">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            >
               ...
               <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-card p-2 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary to-[#00B7FF]"></div>
                  <img 
                    src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80" 
                    alt="Dashboard UI" 
                    className="w-full rounded-2xl border border-slate-100 dark:border-white/5 opacity-80 mix-blend-screen"
                  />
               </div>
            </motion.div>
          </div>
