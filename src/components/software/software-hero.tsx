...
export function SoftwareHero() {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden border-b border-border dark">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-sm font-medium tracking-wide mb-6 backdrop-blur-md">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-slate-900 text-white font-bold text-lg hover:bg-slate-800 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)]"
              >
                Request Demo <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-slate-100 border border-slate-200 text-slate-900 font-bold text-lg hover:bg-slate-800 backdrop-blur-md hover:scale-105 transition-all duration-300"
              >
          ...
          <div className="relative h-[500px] hidden lg:block">
            ...
            >
               <div className="w-full h-full bg-white border border-slate-200 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col relative">
                  {/* Dashboard Header */}
                  <div className="h-12 border-b border-slate-200 flex items-center px-4 gap-2 bg-slate-100">
                     <div className="w-3 h-3 rounded-full bg-red-500/80"></div>
                     <div className="w-3 h-3 rounded-full bg-yellow-500/80"></div>
                     <div className="w-3 h-3 rounded-full bg-green-500/80"></div>
                     <div className="mx-auto px-4 py-1 rounded bg-slate-100 text-[10px] text-slate-600 font-mono">
                  ...
                  <div className="flex-1 p-6 grid grid-cols-12 gap-4">
                     ...
                     <div className="col-span-3 space-y-3">
                        <div className="h-8 rounded bg-slate-100 w-full"></div>
                     ...
                     <div className="col-span-9 space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                           {[
                              ...
                              <div key={i} className="p-4 rounded-xl bg-slate-100 border border-slate-100 flex flex-col gap-2">
                        ...
                        {/* Chart Area */}
                        <div className="h-48 rounded-xl bg-slate-100 border border-slate-100 p-4 flex items-end gap-2">
                  ...
                  <motion.div 
                     ...
                     className="absolute -left-6 top-1/2 p-4 rounded-xl bg-slate-200 backdrop-blur-xl border border-slate-300 shadow-2xl flex items-center gap-4"
                  >
                     <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center">
                        <Lock className="w-5 h-5 text-green-400" />
                     </div>
                     <div>
                        <p className="text-xs text-slate-700 font-bold">Bank-Grade Security</p>
                        <p className="text-[10px] text-slate-600">SOC2 Compliant</p>
                     </div>
                  </motion.div>
               </div>
            </motion.div>
