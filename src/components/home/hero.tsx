        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <Link href="/contact" className={buttonVariants({ size: "lg", className: "rounded-full px-8 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/25" })}>
                Start Your Project <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
              <Link href="/portfolio" className={buttonVariants({ variant: "outline", size: "lg", className: "rounded-full px-8 border-border bg-background/50 backdrop-blur-md" })}>
                View Portfolio
              </Link>
            </div>
          </motion.div>
